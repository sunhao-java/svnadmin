...
<div class="signinpanel">
    <div class="row">
        ...
        <div class="col-sm-5">
            <form method="post" id="loginForm" action="#" onsubmit="return loginSubmit();">
                ...
                <input type="text" class="form-control uname" placeholder="${lbe_usr_txt}" id="userCode" name="usr"
                       required/>
                <input type="password" class="form-control pword m-b" placeholder="${lbe_psw_txt}" id="password"
                       name="psw" required/>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            &copy; 2019 All Rights Reserved. 孙昊
        </div>
    </div>
</div>
